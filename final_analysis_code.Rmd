...
suppressPackageStartupMessages(library(pls, quietly = T))
suppressPackageStartupMessages(library(class, quietly = T))
```
...
```{r residential}
resBldg <- read.csv("EXTR_ResBldg.csv")
...
data_use[, 2:82] <- scale(data_use[, 2:82])
# Check for multicollinearity 
# Create correlation table to inspect collinearity 
check_cor <- as.data.frame(cor(data_use[, 2:82])) %>% 
