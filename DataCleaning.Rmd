...
apt.complex = read_csv("data/EXTR_AptComplex.csv")
```
...
write.csv(cleaned_env,"data/Cleaned_EnvironmentalRestrictions.csv", row.names = FALSE)
```
...
write.csv(cleaned_condo_units,"data/Cleaned_CondoUnit2.csv", row.names = FALSE)
```
